...
public class SensorRocket extends Asset {
    ...
    public SensorRocket(AssetFactory factory, float holeUp) {
        ...
        AttachedImage imageDown = addImage(new BodyImage("data/level1/rocketDown.png", halfHeightUp));
